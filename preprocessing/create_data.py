...
sofamax = sofam.groupby(['encounterid','interventionID',(pd.Grouper(key='chartdelta', freq='12H'))])\
    .agg({'valueNumber':["max"]})
#sofa_binnedlast
...
# Is the patient receiving drugs to make the heart beat harder, or to squeeze
# the blood vessels and increase blood pressure?
